...
add wave -noupdate /gauss_filter_tb/send_data/row
add wave -noupdate /gauss_filter_tb/send_data/col
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {5121159700 ps} 0} {{Cursor 2} {28830000 ps} 0}
...
update
WaveRestoreZoom {29722376800 ps} {29728196 ns}
